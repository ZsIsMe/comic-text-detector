#!/usr/bin/env python3
"""Create icon assets for CTD overlay processor."""
...
PNG_PATH = ROOT / 'ctd_overlay_icon_1024.png'
ICONSET_DIR = ROOT / 'ctd_overlay.iconset'
ICNS_PATH = ROOT / 'ctd_overlay.icns'
...
def create_png() -> None:
    ...
    draw.rounded_rectangle(
        (margin + 34, margin + 34, size - margin - 34, size - margin - 34),
        radius=130,
        outline=border_dark,
        width=6,
    )
